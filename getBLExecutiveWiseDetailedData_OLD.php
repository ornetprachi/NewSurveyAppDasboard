                                                    ...
                                                    if(sizeof($ExeWiseList) > 0 ){
                                                        ...
                                                        ?> 
                                                            <tr style="padding-top:0px">
                                                                ...
                                                                <td>
                                                                    <div id="check_QC" name="check_QC" style="cursor: pointer" class="badge badge-<?php  if ($value['BList_QC_UpdatedFlag'] == 1) { ?>success<?php } elseif($value['BList_QC_UpdatedFlag'] == 0) { ?>warning<?php }elseif($value['BList_QC_UpdatedFlag'] == 2){ ?>danger<?php } ?>">
