                                ...
                                <div class="form-group">
                                    <div class="controls" style="text-align:center;">
                                        <?php if($Building_Plate_Image != '') { ?>
                                            <img src="<?php echo $Building_Plate_Image; ?>" class="docimg rounded img-fluid" width="100%" height="300" alt="Building Plate Photo" title="Building Plate Photo"  name="previewImg2" id="previewImg1" <?php if($Building_Plate_Image != ''){ ?>onclick="window.open(this.src,'_blank','width=auto,height=auto')" <?php } ?>/>
                                        <?php } else { ?>   
