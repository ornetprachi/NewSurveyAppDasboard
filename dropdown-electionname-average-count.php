...
<!-- <div class="col-sm-12"> -->
    <div class="form-group">
        ...
        <div class="controls">
            <select class="select2 form-control" name="electionName" onchange="setElectionNameAverageCountInSession(this.value)" >
            <option value="">--Select--</option>
                ...
                if (sizeof($dataElectionNameAverageCount)>0) 
                {
                    foreach ($dataElectionNameAverageCount as $key => $value) 
                      {
                          if($SurveyUA_Election_Cd_Average_Count == $value["Election_Cd"])
                          {
                ?>
