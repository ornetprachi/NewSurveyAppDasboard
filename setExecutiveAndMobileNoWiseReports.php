...
// Pagination Code -------------------------------------------------------
       ...
       $querygetCount = "SELECT 
            COUNT(MobileNo) as TotalExecutive
            FROM [$ServerIP].[DataAnalysis].[dbo].[All_Duplicate_Mobile_No]";
        ...
        if ($pageNo == 1111111) {
            $offset = 0; // Fetch all records
            $recordPerPage = $Count; // Display all records
        } else {
            $offset = ($pageNo - 1) * $recordPerPage; // Calculate offset for pagination
        }
        
        $ExecutiveQuery = "SELECT * 
            FROM [$ServerIP].[DataAnalysis].[dbo].[All_Duplicate_Mobile_No] 
            WHERE DBName NOT LIKE 'KDMC%' 
            $condMobileExeWise
            $condExeWise
            ORDER BY ExecutiveName ASC, datacnt ASC";
        
        // Apply OFFSET and FETCH NEXT clauses for pagination or display all records
        if ($pageNo != 1111111) {
            $ExecutiveQuery .= " OFFSET $offset ROWS FETCH NEXT $recordPerPage ROWS ONLY";
        }
...
$querygetMobileWiseCount = "SELECT 
                    COUNT(MobileNo) AS TotalMobileWise
                FROM [$ServerIP].[DataAnalysis].[dbo].[All_Duplicate_Mobile_No]";
...
if ($pageNo == 1111111) {
    $offset = 0; // Fetch all records
    $recordPerPage1 = $MobileCount; // Display all records
} else {
    $offset = ($pageNo - 1) * $recordPerPage1; // Calculate offset for pagination
}

// $MobileSearchMobile = "";
$MobileQuery = "SELECT * FROM [$ServerIP].[DataAnalysis].[dbo].[All_Duplicate_Mobile_No] 
    WHERE DBName NOT LIKE 'KDMC%'
    $condMobileWise
...
// Apply OFFSET and FETCH NEXT clauses for pagination or display all records
if ($pageNo != 1111111) {
    $MobileQuery .= " OFFSET $offset ROWS FETCH NEXT $recordPerPage1 ROWS ONLY";
}
...
<?php
    $Div_Inner = "";
    $Div_Inner_First = "";
    if(isset($_SESSION['SurveyUA_Div_Inner']) && !empty($_SESSION['SurveyUA_Div_Inner'])){
        $Div_Inner = $_SESSION['SurveyUA_Div_Inner'];
    }else{
        $Div_Inner = "";
        $Div_Inner_First = "active";
    }
?>
...
<div class="tab-pane" id="home" aria-labelledby="home-tab" role="tabpanel" style="margin-top: -12px;">
    <ul class="nav nav-tabs" role="tablist" style="margin-left:8px;">
        <li class="nav-item" style="font-size: 15px;">
            <a class="nav-link <?php if($Div_Inner == "ExecutiveReportDiv"){ echo "active"; }else{ echo $Div_Inner_First; } ?>" id="ExecutiveWise-tab" data-toggle="tab" href="#ExecutiveWise" aria-controls="ExecutiveWise" role="tab" aria-selected="flase">Executive Wise</a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php if($Div_Inner == "MobileReportDiv"){ echo "active"; }else{} ?>" id="MobileWise-tab" data-toggle="tab" href="#MobileWise" aria-controls="MobileWise" role="tab" aria-selected="true">Mobile No Wise</a>
        </li>
    </ul>
    ...
    <div id='TabLoading' style='display:none'>
        ...
        <div class="tab-pane <?php if($Div_Inner == "ExecutiveReportDiv"){ echo "active"; }else{ echo $Div_Inner_First; } ?>" id="ExecutiveWise" aria-labelledby="ExecutiveWise-tab" role="tabpanel">
                                ...
                                <div class="card-header" style="margin-top: -25px;">
                                    ...
                                    <div class="pagination-area" style="float:right;">
                                        <ul class="pagination justify-content-start">
                                            <li class="page-item">
                                                <a class="page-link" onclick="setPaginationNoInSession(1111111)">Show All</a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="row match-height" style="margin-top:-5px;">
                                            <div class="col-md-12" style="margin-bottom: -30px;">
                                                <div class="card">
                                                    <?php
                                                        $ActionURL = "";
                                                        if(isset($_GET['p']) && $_GET['p'] == "ExecutiveAndMobileNoWise"){
                                                            $ActionURL = "index.php?p=ExecutiveAndMobileNoWise";
                                                        }else{
                                                            $ActionURL = "index.php?p=Survey_Summary_Report";
                                                        }
                                                    ?>
                                                    <div class="content-body">
                                                        <table class="table table-hover-animation table-hover table-striped" id="ExecutiveWiseMobileReport" style="width:100%">
                                                            <thead>
                                                                <tr>
                                                                    <th style="background-color:#36abb9;color: white;vertical-align: middle;font-size:14px;" rowspan="2">Sr No</th>
                                                                    ...
                                                                    <th style="background-color:#36abb9;color: white;">
                                                                        <form action="<?php echo $ActionURL; ?>" method="POST">
                                                                            <input type="text" id="SearchTable" name="MobileSearchExec" value="<?php echo $MobileSearchExec; ?>" placeholder="Search Mobile" style="width: 50%;">
                                                                    ...
                                                                    <th style="background-color:#36abb9;color: white;vertical-align: middle;font-size:14px;" rowspan="2">DB Name</th>
                                                                    <th style="background-color:#36abb9;color: white;vertical-align: middle;font-size:14px;" rowspan="2">Family Nos</th>
                                                                    <th style="background-color:#36abb9;color: white;vertical-align: middle;font-size:14px;" rowspan="2">Mobile No Repeat</th>
                                                                    <th style="background-color:#36abb9;color: white;vertical-align: middle;font-size:14px;" rowspan="2">View</th>
                                                                </tr>
                                                                <tr>
                                                                    <th style="background-color:#36abb9;color: white;vertical-align: middle;font-size:14px;">Executive Name</th>
                                                                    <th style="background-color:#36abb9;color: white;vertical-align: middle;font-size:14px;">Mobile No</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php
        ...
        <div class="tab-pane <?php if($Div_Inner == "MobileReportDiv"){ echo "active"; }else{} ?>" id="MobileWise" aria-labelledby="MobileWise-tab" role="tabpanel">
            <div class="content-body">
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="row match-height" style="margin-top:-5px;">
                                            <div class="col-md-12" style="margin-bottom: -30px;">
                                                <div class="card">
                                                    <div class="content-body">
                                                        <table class="table table-hover-animation table-hover table-striped" style="width:100%" id="MobileWiseReport">
                                                            <thead>
                                                                <tr>
                                                                    <th style="background-color:#36abb9;color: white;vertical-align: middle;font-size:14px;" rowspan="2">Sr No</th>
                                                                    <th style="background-color:#36abb9;color: white;">
                                                                ...
                                                                <tr>
                                                                    <th style="background-color:#36abb9;color: white;font-size:14px;">Mobile No</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php
