...
if(isset($_SESSION['SurveyUA_SiteCd_SurveyQC_DateWise']) && isset($_SESSION['SurveyUA_SiteName_SurveyQC_DateWise'])){
...
<!-- <div class="col-sm-12"> -->
    <div class="form-group">
         ...
         <div class="controls">
            <select class="select2 form-control"  name="SiteName" onchange="setSiteSurveyQCDateWiseInSession(this.value)" >
                    ...
                    foreach ($dataSite as $key => $value) 
                      {
                          ...
                          {
                ?>
                            <option selected="true" value="<?php echo $value['Site_Cd']; ?>~<?php echo $value['SiteName'];?>~<?php echo $value['ElectionName'];?>~<?php echo $value['Election_Cd'];?>~<?php echo $value['ClientName'] ?>"><?php echo "<b>" . $value["SiteName"] . "</b> - " . $value["ClientName"] . " (" . $value["SiteStatus"] . ")" ; ?></option>
                <?php
                          }
                          else
                          {
                ?>
                            <option value="<?php echo $value['Site_Cd']; ?>~<?php echo $value['SiteName'];?>~<?php echo $value['ElectionName'];?>~<?php echo $value['Election_Cd'];?>~<?php echo $value['ClientName'] ?>"><?php echo "<b>" . $value["SiteName"] . "</b> - " . $value["ClientName"] . " (" . $value["SiteStatus"] . ")" ; ?></option>
                <?php
                          }
                      }
                  }
