...
if(
    ...
    (isset($_GET['SurveyDate']) && !empty($_GET['SurveyDate'])) &&
    ...
    if(!empty($DBName)){
        ...
        if(sizeof($result)>0){
            $roomNumbers = array_column($result, 'RoomNo');
            $distinctRoomNumbers = array_unique($roomNumbers);
    
            $roomCount11 = count($distinctRoomNumbers);
        }else{
            $roomCount11 = 0;
        }
                ...
                <div class="row" style="width:100%">
                    <div class="col-md-9" >
                        <div style="padding-top:10px">
                            <h4 class="card-title">Total Count - <?php echo sizeof(($result)) . " ( " . $Date . " ) " ;?></h4>
                        </div>
                    </div>
                    <div class="col-md-3" >
                        <div class="float-right" >
                            <p style="margin-bottom:0">
                                ...
                                <b title="Room Done">RD : <?php echo $roomCount11; ?></php></b>
                            </p>
                        </div>
                    </div>
                </div>
