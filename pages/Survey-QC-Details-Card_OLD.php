                ...
                <div class="col-md-12">
                    <div class="card" style="border:solid 1px #36abb9;">
                        <div class="card-header" style="margin-top:-8px;display: flex;align-items: center; text-align: center;display: inline;">
                            <h3 class="card-title"><b><?php if(array_key_exists('LR_Cd', $Value) == false){ echo "Floor No- ". $Value[0]['FloorNo'] . " | ";};echo $SrNo . ") " ; $SrNo++;?>Room No - <?php echo $Key; if(array_key_exists('LR_Cd', $Value) == false){ echo " (" . count($Value) .")"; }?></b></h3>
                            ...
                            <div class="content-body">
                                <div class="card-content">
                                    <div class="card-body" style="padding:3px;height:120px">
                                        <div class="avatar-content" style="margin-top:-10px" title="<?php echo "Remark - " . $Value['Remark'] ?>" name="LockRoomBounceAnimation_<?php echo $Key;?>" id="LockRoomBounceAnimation_<?php echo $Key;?>" onclick="LockRoomBounceAnimation('<?php echo $Key;?>')">
                                                    ...
                                                    <div class="Voter-Card" style="transition: transform 0.2s ease;margin: 9px 9px 9px 9px;padding:15px;border:solid 1px #36abb9;border-radius: 10px; background-color:white">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-3 col-md-3 col-12" style="margin-left:-45px;margin-top:25px;">
                                                                <img scr="<?php echo $Value1['Photo']; ?>" height="100"  width="100" style="border:solid 1px grey;border-radius:10px;">
                                                            </div>
